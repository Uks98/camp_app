...
Future<LocationMarkerInfo> getGoogleOffices2(String search) async {
  ...
  // 위도 경도가 서로 다름..
  var googleLocationsURL = 'https://apis.data.go.kr/B551011/GoCamping/searchList?numOfRows=10&pageNo=10&MobileOS=AND&MobileApp=A&serviceKey=$_key&_type=json&keyword=$search';
