...
class DetailWidget {
  Widget drawCampDetail(
      {required String campId, required String campName, required String address, required String freeCon, required String mainIntro
        , required String autoSite, required String glamping, required String caravanSite, toilet, shower, freecon2, posblfclty, required var ids, required List data,
        required CampItem campG, required BuildContext context, required Widget googleMap}) {
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 10,),
                Text(campName.toString(), style: TextStyle(fontSize: 20),),
                SizedBox(height: 10,),
                ...
                Container(
                    ...
                    child: Text(mainIntro.toString(), style: TextStyle(
                        fontSize: 14,
                        letterSpacing: 1.1,
                ...
                SizedBox(height: 10,),
                Text(address.toString(), style: TextStyle(fontSize: 14,),),
                SizedBox(height: 10,),
                googleMap,
                SizedBox(height: 20,),
                Divider(thickness: 1, endIndent: 30, indent: 5,),
                ...
                Row(
                  ...
                  children: [
                    SizedBox(width: 5,),
                    campG.kindOfCamp(autoSite.toString(), glamping.toString(),
                ...
                campG.kindOfFacility(
                  freeCon.toString(), toilet.toString(), shower.toString(),),
                SizedBox(height: 10,),
                Divider(thickness: 1, endIndent: 30, indent: 5,),
                SizedBox(height: 10,),
